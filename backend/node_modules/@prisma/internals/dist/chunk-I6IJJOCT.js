...
var chunk_I6IJJOCT_exports = {};
__export(chunk_I6IJJOCT_exports, {
  GetConfigError: () => GetConfigError,
  getConfig: () => getConfig
});
module.exports = __toCommonJS(chunk_I6IJJOCT_exports);
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        return import_chunk_DP4PVU6P.prismaSchemaWasm.get_config(params);
      },
      (e) => ({
        type: "wasm-error",
