...
var chunk_6MO2ZVWD_exports = {};
__export(chunk_6MO2ZVWD_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_6MO2ZVWD_exports);
...
[Context: getDmmf]`;
    super((0, import_chunk_BLCUZQAV.addVersionDetailsToErrorMessage)(errorMessageWithContext));
  ...
  const dmmfPipeline = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        const data = import_chunk_DP4PVU6P.prismaSchemaWasm.get_dmmf(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
